...
<?php // $this->load->view('include/template/common_header') ?>
      ...
      <!-- DeleteModal -->
      <div class="modal fade modal-3d-flip-horizontal" id="deleteVoucherModal" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
      ...
      <!-- End DeleteModal -->
      <!-- RecoverModal -->
      <div class="modal fade modal-3d-flip-horizontal" id="recoverVoucherModal" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      ...
      $(document).ready(function(){
        ...
        table = $('#table_voucher').DataTable({
          ...
          "rowCallback":function(nRow,aData,iDisplayindex){
              branchid = 1;
              if(aData.VOUTYP == 1){
                  $('td:eq(2)',nRow).html("Cash Rcpt");
              } else if(aData.VOUTYP == 2){
                  $('td:eq(2)',nRow).html("Cash Pmnt");
              } else if(aData.VOUTYP == 3){
                  $('td:eq(2)',nRow).html("Bank Withdraw");
              } else if(aData.VOUTYP == 4){
                  $('td:eq(2)',nRow).html("Bank Deposited");
              } else if(aData.VOUTYP == 5){
                  $('td:eq(2)',nRow).html("Journal");
              } else {
                  $('td:eq(2)',nRow).html("Cash Rcpt");
              }
