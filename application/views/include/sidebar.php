...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview<?php echo (isset($page_title) && ($page_title == 'Purchase Intransit List' || $page_title == 'Verify Purchase List' || $page_title == 'Verify Purchase' || $page_title == 'Purchase Return List' || $page_title == 'Purchase Return Add')) ? ' active' : ''; ?>">
                <a href="#">
            ...
            <li class="treeview <?php echo (isset($page_title) && ($page_title == 'Denomination List' || $page_title == 'Add Denomination')) ? 'active' : ''; ?>">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="<?php echo isset($page_title) && $page_title == 'Denomination List' ? 'active' : ''; ?>">
                        <a
                                href="<?php echo site_url('denomination'); ?>"><i class="fa fa-circle-o"></i>
                            Denomination
                            Entry List</a></li>
                    <li class="<?php echo isset($page_title) && $page_title == 'Add Denomination' ? 'active' : ''; ?>">
                        <a
            ...
            <li><a href="<?php echo site_url('voucher/list'); ?>"><i class="fa fa-dashboard"></i> <span>Voucher Entry</span></a>
            </li>
