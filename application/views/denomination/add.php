                            ...
                            <div class="panel-body">
                                ...
                                <div class="row form-group ex-hide">
                                    <div class="col-md-8 col-md-offset-3 text-center">
                                        <button type="button" class="btn btn-primary btn-block op-bal"> Import Previous
                                            Day Balance as
                                            Opening
                                        </button>
                                    </div>
...
<?php $this->load->view('include/template/common_footer'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.op-bal').click(function () {
                var type = $('#TRTYPAC').val();
                if (type)
                    getOpeningBal(type);
                else
                    bootbox.alert("Please Enter Cash Account Type");
            });
            ...
            function getOpeningBal(type) {
                $.ajax({
                    url: site_url + 'denomination/getOpBal/' + type,
                    dataType: 'JSON',
                    success: function (response) {
                        var data = response.finalDenominations;
                        var dre_note = $('.dre_note');
                        dre_note[0].value = data.F2000;
                        dre_note[1].value = data.F500;
                        dre_note[2].value = data.F200;
                        dre_note[3].value = data.F100;
                        dre_note[4].value = data.F50;
                        dre_note[5].value = data.F20;
                        dre_note[6].value = data.F10;
                        dre_note[7].value = data.F5;
                        $('.dre_misc').val(data.FMISC).trigger('change');
